...
class QueryConfig(YamlModel):
    ...
    community_context_levels: int = 3
    ...
    # document config
    max_document_display_length: int = 8000
    max_smart_truncate_length: int = 8000
    truncate_head_chars: int = 4000
    truncate_tail_chars: int = 3000