...
from Core.Query.HKGraphTreeQuery import HKGraphTreeQuery
...
class QueryFactory:
    def __init__(self):
        self.creators = {
            ...
            "hk_tree": self._create_hk_tree_query,
    ...
    @staticmethod
    def _create_hk_tree_query(config, retriever):
        return HKGraphTreeQuery(config, retriever)
